...
/**
 * Standard wrapper (from the AndroidX ViewPager2 samples) that lets a horizontal
 * child (e.g. the recents row) scroll without the surrounding ViewPager2
 * stealing the gesture — the pager only takes over once the child can't
